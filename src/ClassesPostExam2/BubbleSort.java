...
//		}
	...
	for (int oForIndex = 0; oForIndex < numbers.length - 1; oForIndex++)//dictates how many steps
		{
	...
	//BEGIN INNER FOR LOOP
		for (int iForIndex = 0; iForIndex < numbers.length - 1 - oForIndex; iForIndex++)
			if(numbers[iForIndex] > numbers[iForIndex+1])
			{
				int temp = numbers[iForIndex];
				numbers[iForIndex] = numbers[iForIndex+1];
				numbers[iForIndex+1] = temp;
			}
	//END INNER FOR LOOP
