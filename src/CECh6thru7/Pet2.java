/** Revised class for basic pet data: name, age, and
 *  weight.
 *   */ 
public class Pet2 
{
...
//tested this and if datatype of arg is the same get ERROR as expected
//because Java uses the constructor name and datatype to differentiate
//so it can't figure out what to do b/c it sees duplicate even though the 
//arg name is different. 
//		public Pet2(int initialWeight) 
//	{
//		set("No name yet.", 0, initialWeight); 
//	}
